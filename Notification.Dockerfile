...
ADD ./bin/notification /app/bin/
WORKDIR /app

ADD ./data/mysql/migrations/notification /data/mysql/migrations/notification
ENV NOTIFICATION_MIGRATIONS_DIR=/data/mysql/migrations/notification
